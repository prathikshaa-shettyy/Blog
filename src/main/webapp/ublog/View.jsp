<%@ page import="com.techm.ublog.dto.PostDTO" %>
<%@ page import="com.techm.ublog.utils.DateTimeFormatter" %>
...
<!--
    ...
    in the top left corner of the web page as .
-->
...
<!--
    TODO: 4.26. Design the "View Post After Creation" page with the following properties.
        ...
        2. Retrieve the PostDTO object from the request object and print the data on this page as. (Hint: You need to use the JSP expression tag to get the value from
