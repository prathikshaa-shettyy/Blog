...
<!--
	TODO: 7.4. Design the "Search Post" page with the following properties.
	    ...
	    3. Provide "User Email:" label along with the text field as
...
<!--
    ...
    TODO: 7.12. Check if posts exist in the request object. If so, then display the posts as
     Note: Use the table tag to align the fields.
     Note: Try to provide a horizontal rule or some spacing between the posts as
-->